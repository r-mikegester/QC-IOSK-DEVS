  ...
  return (
    <>
      {/* <button
        ...
        className="absolute  bottom-8 backdrop-blur-lg bg-base-100 text-base-content right-5 z-50 flex aspect-square min-h-[32px] w-12 flex-col items-center scale-125 gap-1 justify-center rounded-xl border border-gray-800 hover:bg-base-300 hover:scale-105 duration-200 ease-in-out"
      >
