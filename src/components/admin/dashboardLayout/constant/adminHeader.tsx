          ...
          <div className="hidden sm:block">
            ...
            <div className="relative">
              ...
              <input
                ...
                id="icon"
                name="icon"
                className="block w-full px-4 py-2 text-sm border-gray-200 rounded-lg ps-11 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                placeholder="Search"
              />
            </div>
          </div>
