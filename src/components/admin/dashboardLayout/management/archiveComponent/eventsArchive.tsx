    ...
    return (
        <>
            <div className="flex items-center space-x-2 justify-between">
                ...
                <h1 className="font-bold text-4xl">Archived Events</h1>
            ...
            >
                <div className="bg-base-100 rounded-2xl h-56 w-96 shadow-xl p-6">
                    ...
                    <div className="mt-6 space-x-3 flex justify-center">
                        <button onClick={deleteArchiveEvent} className="btn btn-primary hover:bg-red-500 text-white">
                            Yes, Delete Forever
                        </button>
            ...
            >
                <div className="bg-base-100 rounded-2xl h-56 w-96 shadow-xl p-6">
                    ...
                    <div className="mt-14 space-x-3 flex justify-center">
                        <button onClick={restoreArchiveEvent} className="btn bg-warning hover:bg-orange-500 text-white">
                            Yes, Restore
                        </button>
