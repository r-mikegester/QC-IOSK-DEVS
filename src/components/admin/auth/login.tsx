          ...
          <div>
            <div className="flex">
              ...
              <div className="w-screen h-screen">
                <section className="bg-base-100 border border-gray-200 shadow-inner">
                  <div className="p-4 sm:p-7 w-full h-screen">
                      ...
                      <form>
                        <div className="grid gap-y-4">
                          ...
                          <div className="flex space-x-3">
                            <button
                              onClick={onLogin}
                              className="inline-flex items-center justify-center w-full px-4 py-3 text-sm font-semibold text-base-content bg-base-300 border-2 gap-x-2 rounded-2xl hover:bg-base-200 disabled:opacity-50 disabled:pointer-events-none"
                            >
                              Sign in
                            </button>
                            <NavLink
