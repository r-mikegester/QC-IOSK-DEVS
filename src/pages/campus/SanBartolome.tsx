  ...
  const handleTimeBasedToggle = () => {
    ...
    if (currentTimeInRange) {
      ...
      setTimeout(() => {
        ...
        setIsEnvironment(false); // Modify environment settings as needed
        setIsLoading(false);
      ...
      setTimeout(() => {
        ...
        setIsEnvironment(true); // Modify environment settings as needed
        setIsLoading(false);
  ...
  return (
    <>
      <button
        ...
        className="absolute dark:border-slate-600/60 bottom-8 backdrop-blur-lg bg-slate-800/30 right-5 z-50 flex aspect-square min-h-[32px] w-12 flex-col items-center scale-125 gap-1 justify-center rounded-xl border border-gray-800  text-gray-700 hover:bg-sky-700 hover:scale-105 duration-200 ease-in-out dark:text-sky-300"
      >
        <Icon icon="icon-park-outline:dark-mode" className="w-6 h-6" />
      </button>
      ...
      {isLoading && (
        <div className="loading-spinner">
          ...
          <h1 className="absolute inset-0 text-green-500 z-50">Loading...</h1>
      ...
      >
        ...
        <Suspense fallback={null}>
          ...
          <Bounds fit clip observe margin={1.2}>
            ...
            <Stage
              environment={isEnvironment ? "city" : "night"}
              adjustCamera
              shadows
            >
