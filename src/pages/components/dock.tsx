...
const Dock: React.FC<ContainerProps> = ({ name }) => {
  return (
    ...
    <div className="fixed bottom-6 left-1/2 h-20 transform -translate-x-1/2 inline-flex mx-auto justify-between dark:bg-slate-800/50 w-8/12 sm:w-5/12 md:w-4/12 lg:w-3/12 xl:w-2/12 rounded-2xl">
      <a
        aria-current="page"
      ...
      <a className="btn bg-transparent border-none hover:bg-transparent relative inline-flex flex-col items-center text-xs font-medium text-blue-300  py-3 px-6 flex-grow" href="/Map">
