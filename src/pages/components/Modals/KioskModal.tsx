...
const KioskModal: React.FC = () => {
    ...
    return (
        <dialog id="KioskManual" className="modal">
            <div className="modal-box text-center backdrop-blur-lg bg-slate-800/80 rounded-3xl w-11/12 max-w-5xl">
                <h3 className="font-bold text-4xl ">HOW TO USE QC-IOSK</h3>
                <p className="text-center dark:text-gray-200 mb-10">Use your finger to swipe thru slides </p>
                <div className="w-full rounded-2xl h-96 bg-transparent backdrop-lg ">
                    <Swiper
                        pagination={{
                            dynamicBullets: true,
                        }}
                        modules={[Pagination]}
                        className="mySwiper rounded-2xl bg-transparent"
                        spaceBetween={50}
                        slidesPerView={1}
