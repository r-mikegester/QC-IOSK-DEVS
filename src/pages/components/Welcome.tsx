        ...
        <section onClick={handleClick} className="w-screen text-center cursor-pointer place-items-stretch overflow-hidden min-h-screen  bg-black h-full">
          ...
          <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
            <div className="max-w-md text-center">
              <img src={QCULogo} className="mx-auto absolute inset-x-0 top-96 w-40 xl:w-72 -mt-56 xl:-mt-80" alt="QCU Logo" />
              <h2 className="mb- font-extrabold text-7xl dark:text-gray-600">
                <span className="absolute inset-x-0 top-80 mt-3 xl:mt-16 bg-clip-text bg-gradient-to-tr drop-shadow-md text-5xl from-blue-600 to-purple-400 text-transparent">QCU-IOSK</span>
              </h2>
