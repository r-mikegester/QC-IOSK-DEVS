          ...
          <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 xl-mt-16 sm:py-24">
            <div className="text-center">
              ...
              <div className="mt-1 sm:mt-20">
                <a className="m-1 ease-in-out duration-300 btn py-3 px-4 inline-flex items-center gap-x-2 text-sm rounded-lg border-none text-gray-800 shadow-sm hover:bg-gray-500 disabled:opacity-50 disabled:pointer-events-none   dark:text-white bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
                ...
                <a className="m-1 ease-in-out duration-300 btn py-3 px-4 inline-flex items-center gap-x-2 text-sm rounded-lg border border-gray-200 text-gray-800 shadow-sm hover:bg-gray-500 disabled:opacity-50 disabled:pointer-events-none   dark:text-white bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
                  <svg className="flex-shrink-0 w-3 h-auto" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                ...
                <a className="m-1 ease-in-out duration-300 btn py-3 px-4 inline-flex items-center gap-x-2 text-sm rounded-lg border border-gray-200 text-gray-800 shadow-md hover:bg-gray-500 disabled:opacity-50 disabled:pointer-events-none   dark:text-white bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
                  <svg className="flex-shrink-0 w-3 h-auto" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
