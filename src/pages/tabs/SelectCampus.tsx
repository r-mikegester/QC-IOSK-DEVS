        ...
        <main>
          <ul className="slider" ref={(ref) => setSlider(ref)}>
            ...
            <li
              ...
              style={{
                backgroundImage:
                  "url('../../../public/SelectCampus/Batasan.webp')",
              }}
            >
            ...
            <li
              className="item"
              style={{
                backgroundImage: `url('../../../public/SelectCampus/SanBartolome.webp')`,
              }}
            >
              <div className="content">
            ...
            <li
              className="item"
              style={{
                backgroundImage: `url("../../../public/SelectCampus/SanFrancisco.webp")`,
              }}
            >
              <div className="content">
            ...
            <li
              className="item"
              style={{
                backgroundImage: `url('../../../public/SelectCampus/Batasan.webp')`,
              }}
            >
              <div className="content">
                <h2 className="title">QCU - BATASAN</h2>
