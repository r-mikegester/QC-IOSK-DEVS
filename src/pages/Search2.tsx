...
import {
  ...
  getDocs,
  Firestore,
} from "firebase/firestore"; // Added Firestore type
              ...
              <div className="text-center mt-[10px]">
                ...
                >
                  <div>
                    <div>
                      <input
                        className="input input-bordered placeholder-shown:text-base-content outline-none ring-0 bg-base-100 w-[650px] h-16 rounded-2xl text-base-content join-item"
                        placeholder="Search..."
                        value={input}
                  ...
                  <div className="indicator">
                    <button
                      className="w-20 h-16 text-base-content bg-base-100 btn hover:bg-base-300 rounded-2xl join-item"
                      ...
                      <div className="w-[730px] py-2 bg-base-100 rounded-2xl">
                        <div className="grid grid-cols-1">
                          <div className="mt-5 space-x-2">
                            <div className="text-base-content bg-base-300 badge badge-lg ">
                              Faculties
                            </div>
                            <div className="text-base-content bg-base-300 badge badge-lg ">
                              Facilities
